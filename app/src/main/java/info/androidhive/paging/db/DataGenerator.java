...
public class DataGenerator {
    ...
    private static final String[] animals = new String[]{
            ...
            "elephant-seal", "elk", "emu", "falcon", "ferret", "finch", "fish", "flamingo",
            ...
            "jaguar", "jay", "jellyfish", "kangaroo", "kingfisher", "koala", "komodo-dragon",
            ...
            "panther", "parrot", "partridge", "peafowl", "pelican", "penguin", "pheasant",
            "pig", "pigeon", "polar-bear", "pony", "porcupine", "porpoise", "prairie-dog",
            "quail", "quelea", "quetzal", "rabbit", "raccoon", "rail", "ram", "rat", "raven",
            "red-deer", "red-panda", "reindeer", "rhinoceros", "rook", "salamander", "salmon",
            "sand-dollar", "sandpiper", "sardine", "scorpion", "sea-lion", "sea-urchin",
            ...
            "toad", "trout", "turkey", "turtle", "vicuña", "viper", "vulture", "wallaby",
    ...
    public static List<AnimalEntity> getSampleAnimalList() {
        ...
        for (int i = 0; i < animals.length; i++) {
            animalList.add(new AnimalEntity(i, animals[i]));
        }
        return animalList;
    }
}
